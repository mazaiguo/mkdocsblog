...
tags:
  ...
  - 目录遍历
  - JSON
description: Python脚本实现批量处理子目录文件，重命名并拷贝文件，生成JSON配置文件
authors:
  - JerryMa
---

# 将子目录中的所有文件拷贝到子目录中并添加前缀

![](http://image.mazaiguo.xyz//images/20240823-20240823110721.png)
