...
tags:
  - AutoCAD
description: "The contents of a table can be made read-only by setting the cell state of the table cells."
author: Autodesk
---
# Creating a table with read-only contents

发布日期: 2012-04-01

原始链接: https://adndevblog.typepad.com/autocad/2012/04/creating-a-table-with-read-only-contents.html

## 文章内容

By Balaji Ramamoorthy
The contents of a table can be made read-only by setting the cell state of the table cells.
Here is a sample code that creates a table with the cell state set to "AcDb::kCellStateContentReadOnly"
    1 AcGePoint3d insPoint;
